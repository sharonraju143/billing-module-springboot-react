      ...
      <React.Fragment>
        ...
        <Box sx={{ display: "flex" }}>
          ...
          >
            ...
            <Grid container spacing={3}>
              <Grid sx={{ px: 2, py: 4, m: 2 }} item xs={11.2} md={8} lg={8.5}>
              ...
              {data?.totalAmount && (
                <Grid sx={{ px: 2, py: 4, m: 2 }} item xs={11.2} md={4} lg={3}>
                  <Paper
                    sx={{
                      p: 2,
                      display: "flex",
              ...
              <Grid sx={{ px: 2, py: 4, m: 2 }} item xs={11.2} md={8} lg={7.5}>
                <ServicesChart dataset={data && data?.top10Services} />
              </Grid>

              <Grid sx={{ px: 2, py: 4, m: 2 }} item xs={11.2} md={8} lg={4}>
